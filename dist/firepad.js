...
firepad.FirebaseAdapter = (function (global) {
  ...
  FirebaseAdapter.prototype.saveCheckpoint_ = function() {
    this.ref_.child('checkpoint').set(this.getCheckpoint_());
  };
  
  FirebaseAdapter.prototype.getCheckpoint_ = function() {
    return {
      a: this.userId_,
